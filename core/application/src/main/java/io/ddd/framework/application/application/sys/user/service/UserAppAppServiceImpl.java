package io.ddd.framework.application.application.sys.user.service;

import io.ddd.framework.application.application.sys.user.command.UserAddCmdExe;
import io.ddd.framework.application.application.sys.user.command.UserUpdateCmdExe;
import io.ddd.framework.application.application.sys.user.command.query.UserGetQryExe;
import io.ddd.framework.application.application.sys.user.command.query.UserInfoGetQryExe;
import io.ddd.framework.application.application.sys.user.command.query.UserListQryExe;
import io.ddd.framework.application.application.sys.user.command.query.UserPageQryExe;
import io.ddd.framework.coreclient.api.sys.UserAppService;
...
import io.ddd.framework.application.application.sys.user.command.UserDeleteCmdExe;
