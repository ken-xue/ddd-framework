package io.ddd.framework.application.application.sys.userofrole.service;

import io.ddd.framework.application.application.sys.userofrole.command.UserOfRoleAddCmdExe;
import io.ddd.framework.application.application.sys.userofrole.command.UserOfRoleDeleteCmdExe;
import io.ddd.framework.application.application.sys.userofrole.command.UserOfRoleUpdateCmdExe;
import io.ddd.framework.application.application.sys.userofrole.command.query.UserOfRoleGetQryExe;
import io.ddd.framework.application.application.sys.userofrole.command.query.UserOfRoleListQryExe;
import io.ddd.framework.coreclient.api.sys.UserOfRoleAppService;
import io.ddd.framework.coreclient.dto.sys.userofrole.*;
import io.ddd.framework.application.application.sys.userofrole.command.query.UserOfRolePageQryExe;
