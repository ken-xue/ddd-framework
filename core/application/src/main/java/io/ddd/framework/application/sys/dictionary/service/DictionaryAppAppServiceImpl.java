package io.ddd.framework.application.sys.dictionary.service;

import io.ddd.framework.application.sys.dictionary.command.DictionaryAddCmdExe;
import io.ddd.framework.application.sys.dictionary.command.DictionaryDeleteCmdExe;
import io.ddd.framework.application.sys.dictionary.command.DictionaryUpdateCmdExe;
import io.ddd.framework.application.sys.dictionary.command.query.DictionaryGetQryExe;
import io.ddd.framework.application.sys.dictionary.command.query.DictionaryListQryExe;
import io.ddd.framework.application.sys.dictionary.command.query.DictionaryPageQryExe;
