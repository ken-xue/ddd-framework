package io.ddd.framework.application.sys.role.service;
import io.ddd.framework.application.sys.role.command.RoleAddCmdExe;
import io.ddd.framework.application.sys.role.command.RoleDeleteCmdExe;
import io.ddd.framework.application.sys.role.command.RoleUpdateCmdExe;
import io.ddd.framework.application.sys.role.command.query.RoleGetQryExe;
import io.ddd.framework.application.sys.role.command.query.RoleListQryExe;
import io.ddd.framework.application.sys.role.command.query.RolePageQryExe;
