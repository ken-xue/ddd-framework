package io.ddd.framework.application.application.sys.log.service;

import io.ddd.framework.application.application.sys.log.command.LogAddCmdExe;
import io.ddd.framework.application.application.sys.log.command.LogDeleteCmdExe;
import io.ddd.framework.application.application.sys.log.command.LogUpdateCmdExe;
import io.ddd.framework.application.application.sys.log.command.query.LogGetQryExe;
import io.ddd.framework.application.application.sys.log.command.query.LogListQryExe;
import io.ddd.framework.application.application.sys.log.command.query.LogPageQryExe;
