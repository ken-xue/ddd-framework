package io.ddd.framework.application.application.sys.roleofmenu.service;

import io.ddd.framework.application.application.sys.roleofmenu.command.query.RoleOfMenuListQryExe;
import io.ddd.framework.application.application.sys.roleofmenu.command.query.RoleOfMenuPageQryExe;
import io.ddd.framework.coreclient.api.sys.RoleOfMenuAppService;
import io.ddd.framework.application.application.sys.roleofmenu.command.RoleOfMenuAddCmdExe;
import io.ddd.framework.application.application.sys.roleofmenu.command.RoleOfMenuDeleteCmdExe;
import io.ddd.framework.application.application.sys.roleofmenu.command.RoleOfMenuUpdateCmdExe;
import io.ddd.framework.application.application.sys.roleofmenu.command.query.RoleOfMenuGetQryExe;
